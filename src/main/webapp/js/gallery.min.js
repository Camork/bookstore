!function (a, b) {
    ...
    function f(b) {
        if (e(), "string" == typeof b && (b = document.querySelector(b)), b && "object" == typeof b && b.nodeType) {
            ...
            var p = h.paddingLeft + h.paddingRight, q = h.paddingTop + h.paddingBottom, r = h.marginLeft + h.marginRight,
                s = h.marginTop + h.marginBottom, t = h.borderLeftWidth + h.borderRightWidth, u = h.borderTopWidth + h.borderBottomWidth, v = k && g,
                w = a(f.width);
    ...
    return c.htmlInit = function (b, e) {
        c.docReady(function () {
            var f = c.toDashed(e), g = "data-" + f, h = document.querySelectorAll("[" + g + "]"), i = document.querySelectorAll(".js-" + f),
                j = c.makeArray(h).concat(c.makeArray(i)), k = g + "-options", l = a.jQuery;
    ...
    var g = document.documentElement.style, h = "string" == typeof g.transition ? "transition" : "WebkitTransition",
        i = "string" == typeof g.transform ? "transform" : "WebkitTransform",
        j = {WebkitTransition: "webkitTransitionEnd", transition: "transitionend"}[h], k = [i, h, h + "Duration", h + "Property"],
    ...
    l.constructor = e, l._create = function () {
        ...
        var a = getComputedStyle(this.element), b = this.layout._getOption("originLeft"), c = this.layout._getOption("originTop"),
            d = a[b ? "left" : "right"], e = a[c ? "top" : "bottom"], f = this.layout.size,
        ...
        var a = this.layout.size, b = {}, c = this.layout._getOption("originLeft"), d = this.layout._getOption("originTop"),
            e = c ? "paddingLeft" : "paddingRight", f = c ? "left" : "right", g = c ? "right" : "left", h = this.position.x + a[e];
    ...
    l.ontransitionend = function (a) {
        if (a.target === this.element) {
            var b = this._transn, c = n[a.propertyName] || a.propertyName;
    ...
    return c.compatOptions.fitWidth = "isFitWidth", c.prototype._resetLayout = function () {
        ...
        var c = b(a), d = this._getElementOffset(a), e = this._getOption("originLeft"), f = e ? d.left : d.right, g = f + c.outerWidth,
...
!function (a) {
    var b = {
        init: function (b) {
            ...
            return this.each(function (c) {
                    ...
                    if (G) {
                        ...
                        d.off("click.galleryExpand").off("mouseenter.galleryExpand").off("mouseleave.galleryExpand"), g.scrollTop(0), g.attr("style", D.attr("style")), L.css("left", D.find(".gallery-cover").css("left")).removeClass("dh ep"), _(), a("body").css("overflow", ""), g.css("overflowY", ""), d.css({
                            ...
                            if (a(window).off("resize", B), J.find(".gallery-body").css("display", "none"), P && P.find(U).removeClass("k"), a("nav").removeClass("ed"), a("#placeholder-navbar").fadeOut(b.outDuration, "easeInQuad", function () {
                                ...
                                var f = {};
                                S && Q ? (f.width = n, f.height = o, f.transform = "translate3d(" + p.left + "px, " + V + "px, 0)", f.transition = "transform " + b.outDuration / 1e3 + "s, width " + b.outDuration / 1e3 + "s, height " + b.outDuration / 1e3 + "s", f["-webkit-transition"] = "-webkit-transform " + b.outDuration / 1e3 + "s, width " + b.outDuration / 1e3 + "s, height " + b.outDuration / 1e3 + "s", $.css({background: ""})) : (f.transform = "translate3d(" + (p.left - A - V) + "px, 0, 0)", f.transition = "transform " + b.outDuration / 1e3 + "s " + W, f["-webkit-transition"] = "-webkit-transform " + b.outDuration / 1e3 + "s " + W), L.css(f), M.css({
                ...
                var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = !0, G = !1, H = !1, I = !0, J = a(this),
                    K = J.attr("id") || c.toString(), L = J.find(".gallery-cover"), M = J.find(".gallery-header"),
                    N = J.find(".gallery-curve-wrapper"), O = J.find(".gallery-body"), P = J.find(".gallery-action"),
                    Q = !!L.length && (a(this).attr("data-fillScreen") || b.fillScreen), R = a(this).hasClass("gallery-horizontal"), S = !1, T = 64,
                    U = ".btn, .btn-large, .btn-floating", V = b.contentPadding, W = "cubic-bezier(0.420, 0.000, 0.580, 1.000)",
                    X = a(document).width(), Y = window.innerHeight, Z = !1;
                g = J.children(".placeholder").first(), g.length || (J.wrapInner(a('<div class="placeholder"></div>')), g = J.children(".placeholder").first()), M.length || (M = a('<div class="gallery-header invisible"></div>'), L.length ? L.after(M) : N.append(M));
                ...
                var _ = function () {
                    ...
                    origContainerRect = J[0].getBoundingClientRect(), h = origContainerRect.width, i = J.height(), j = M[0].getBoundingClientRect(), k = j.width, l = j.height || 1, n = L.width(), o = L.height(), p = L.length ? L[0].getBoundingClientRect() : {
                        top: j.top,
                        left: 0
                ...
                J.off("click.galleryExpand").on("click.galleryExpand", function (c) {
                    ...
                    var d, q, _, ba, ca, da = function () {
                        ...
                        if (Z = Z && ("visible" == c.overflow || "visible" == c.overflowY || "auto" == c.overflow || "auto" == c.overflowY), T = f ? 56 : 64, t = -J[0].getBoundingClientRect().top, u = void 0 === u ? -g[0].getBoundingClientRect().left : u + -g[0].getBoundingClientRect().left, V = f ? 20 : b.contentPadding, v = Math.round(o / 2 + V + T), d = o / 2 - V, q = .7 * X, _ = Y - d - T, A = Math.max((X - q) / 2, V), f && (q = X, A = 0), S)if (Q) {
                            var e = L.children("img").first(), j = imgHeight = 1 / 0;
                            if (e.length) {
                    ...
                    if (da(), D = g.clone(!0), a("body").css("overflowX", "hidden"), a("body").on("scroll.disable-scroll mousewheel.disable-scroll touchmove.disable-scroll", function (a) {
                        ...
                        }), J.css({height: i, width: h}), L.length) {
                        E = L.attr("style");
                        var ea = "translate3d(";
                        Q ? ea += p.left + "px, " + V + "px, 0)" : (L.css({left: A + V, top: V}), ea += p.left - A - V + "px, 0, 0)"), L.css({
                            height: o,
                            width: n,
                            transform: ea
                        })
                    ...
                    var fa = p.top - T - V;
                    N.css({display: "block", transform: "translate3d(0, " + fa + "px, 0)"}), m = R ? V - l : V, M.css({
                        height: l,
                        width: k,
                        transform: "translate3d(" + j.left + "px," + m + "px,0)"
                    }), g.css({
                    ...
                    }), J.addClass("k"), "absolute" !== J.css("position") && J.css({position: "relative"}), H = !0, I = !1;
                    ...
                    var ha = a('<nav id="placeholder-navbar"></nav>'), ia = a('<div class="nav-wrapper"></div>'), ja = a('<div class="db"></div>'),
                        ka = a('<button class="back-btn"><i class="material-icons">arrow_back</i><span>Back</span></button>'), la = "";
                    if (a("nav").length && (la = a("nav").css("background-color"), a("nav").addClass("ed")), ha.css({"background-color": la}), ja.append(ka), ia.append(ja), ha.append(ia), g.prepend(ha), ka.click(function () {
                            e()
                        ...
                        try {
                            x = w.getPalette(J.find("img")[0], 2), y = "rgb(" + x[0][0] + "," + x[0][1] + "," + x[0][2] + ")", z = "rgb(" + x[1][0] + "," + x[1][1] + "," + x[1][2] + ")", ha.css({backgroundColor: z})
                        } catch (c) {
                            ...
                            if (na.length) {
                                var oa = imgHeight = 0, ma = L.children("img").first();
                                if (ma.length) {
                    ...
                    ga.css({backgroundColor: y}), Q && $.length && $.css({background: "linear-gradient(to bottom, rgba(0,0,0,0) 0%, " + y + " 100%)"});
                    var qa = {};
                    if (qa.transform = "", qa.transition = "transform " + b.inDuration / 1e3 + "s", qa["-webkit-transition"] = "-webkit-transform " + b.inDuration / 1e3 + "s", S)if (Q) {
                    ...
                    ra(), O.length && (O.css({
                        ...
                        padding: V,
                        minHeight: Y - v
                    }), !Q && L.length && (f ? O.find(".title-wrapper").css({marginTop: v / 2}) : O.find(".title-wrapper").css({
                        marginLeft: n,
                        paddingLeft: V,
                        height: d
                    }))), P.length && (P.css({top: v}), P.find(U).each(function () {
                        a(this).css({backgroundColor: z})
                        ...
                        var c = function () {
                            D = g.clone(!0), g.css({
                                ...
                                left: 0,
                                overflow: "auto"
                            }), Z && (a("body").css("overflow", "hidden"), g.css("overflowY", "scroll")), a("body").off("scroll.disable-scroll mousewheel.disable-scroll touchmove.disable-scroll"), N.css({height: "100%"}), Q ? L.css({
                                width: "",
                                height: "",
                                transform: "",
                                transition: "opacity .3s"
                            }) : L.css({left: V}), L.addClass("dh"), M.hide()
                        };
    ...
    a(function () {
        ...
        if (b.length) {
            ...
            c.each(function () {
                ...
                b.on("click", function () {
                    ...
                    var e = b.find("a").first()[0].hash.substr(1), f = a(".b .gallery-item");
                    if (f.stop().addClass("ce").fadeIn(100), "all" !== e) {
                        var g = f.not("." + e).not(".all");
                        g.removeClass("ce").hide()
                    }
                    d.masonry({transitionDuration: ".3s"}), d.one("layoutComplete", function (a, b) {
                        d.masonry({transitionDuration: 0})
                    }), setTimeout(function () {
                        d.masonry("layout")
                    }, 1e3)
                })
        ...
        a(".t:not(.carousel-slider)").carousel({dist: 0, padding: 10}), a(".t.carousel-slider").carousel({
            fullWidth: !0,
            indicators: !0,
        ...
        var d = a(".b");
        d.masonry({itemSelector: ".ce", columnWidth: ".ce", transitionDuration: 0}), d.imagesLoaded(function () {
            d.masonry("layout")
        }), a("a.filter").click(function (a) {
            a.preventDefault()
        }), a("form .form-control").focus(function () {
            a(this).siblings("label").first().children("i").first().css({color: "#aaa", left: 0})
        }), a("form .form-control").blur(function () {
            a(this).siblings("label").first().children("i").first().css({color: "transparent", left: "-20px"})
        });
        var e = function (a) {
            var b = a.find(".t.initialized");
            b.carousel({dist: 0, padding: 10})
        };
        a(".gallery-expand").galleryExpand({onShow: e}), a(".blog .gallery-expand").galleryExpand({onShow: e, fillScreen: !0, inDuration: 500})
    })
}(jQuery);